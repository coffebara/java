...
class Student2 {
	...
	public Student2(String name, boolean isMaile, int hak, int ban, int score) {
		super();
		this.name = name;
		this.isMale = isMaile;
		this.hak = hak;
	...
	// groupingBy()에서 사용
	enum Level { HIGH, MID, LOW } // 성적을 상, 중, 하 3 단계로 분류
...
public class Ex14_10 {
	public static void main(String[] args) {
		Student2[] stuArr = {
				...
				new Student2("이미지", false,	1,  2,  150),
		...
		List<Student2> femaleStudnet = stuBySex.get(false);
		
		for(Student2 s : maleStudent) System.out.println(s);
		for(Student2 s : femaleStudnet) System.out.println(s);
