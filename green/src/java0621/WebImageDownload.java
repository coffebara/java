...
//웹에 있는특정한 이미지 파일을 한정된 버퍼를사용하여 다운로드하는 프로그램을 작성해보자
// 한정된 버퍼의 크기는 2048바이트로 한다
...
// byte 형 배열 buffer를 선언하고 그 크기를 2048로 지정함
...
//기존의 파일이 존재할 때는 그 내용을 지우고 새로운 파일을 생성
		...
		}// try() 괄호 안에 들어가는 것은 자원에 해당됩니다, 두개의자원이 들어가 있죠
	}// try 문장이 끝나면 자동으로 해제됩니다, close()생략이 가능합니다.
}
