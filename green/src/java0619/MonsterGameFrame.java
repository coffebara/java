...
//컨텐트팬은 Container타입이므로 Container를 상속받은 어떤 컴포넌트도 컨텐트팬이 될 수 있다.
        ...
        gamePanel.requestFocusInWindow(); // 게임 패널에 포커스 설정
        gamePanel.setFocusable(true); // 포커스를 받을 수 있도록 설정
    ...
    class GamePanel extends JPanel {
        ...
        public GamePanel(String avatarChar, String monsterChar, char quitChar, long monsterDelay) {
            ...
            // 아바타와 괴물 레이블 생성
            avatar = new JLabel(new ImageIcon("car1.gif")); // 아바타 이미지 추가
            monster = new JLabel(new ImageIcon("car2.gif"));
    ...
    class MonsterThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                // 괴물의 위치 수정MonsterGameFrame.java
