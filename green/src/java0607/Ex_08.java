...
//인수에서 전달하는 변수 타입에 따라 String에 될 수도 있고 Interger가 될 수도 있다
//이런 대문자 변수들을 랩퍼 클래스라고 하며
//랩퍼 클래스 변수는 자체로 클래스가 된다(이미 정의되있기 때문에 별도의 선언은 불필요)
	void print(T x);
}
