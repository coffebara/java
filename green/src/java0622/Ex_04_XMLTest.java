...
//API(Application Programming Interface)는 애플리케이션 소프트웨어를구축하고
...
//새로운 틀과 제품을 설꼐하거나 기존 틀과 제품을 관리하는 경우
//API는 유연성을 제공하고 설계, 관리, 사용 방법을 간소화하며 혁신의 기회를 제공한다.
//
//URL은 인터넷에 존재하는 여러 서버들이제공하는 자원에 접근할 수 있는
//주소를 표현하기 위한 것으로
...
public class Ex_04_XMLTest {
	public static void main(String[] args){
		try{
//	파싱할 URL을 지정한다.
//	파싱은 어떤 페이지(문서, html 등)에서 내가 원하는 데이터를 특정 패턴이나
//	순서대로 추출해 가공하는 것을 말한다.
}}
}
