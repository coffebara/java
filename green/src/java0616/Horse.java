...
//	2. 완성해야할서비스와 예상되는사용자 경험을 미리 보기 위한 방법이다.
//작성법
// 1. 스토리보드 표지엔 프로젝트 명, 문서버전정보, 최종업데이트일자, 작성자 등의 정보기재
//  	- 협업 프로젝트에서 버전 관리정보가 중요하다. 팀전체가 내용을 공유,
//  	  유기적 개발 진행
//Wireframe
// 1. UI중심의 화면 레이아웃을 설계하여 선과 뼈대를 만드는 것.
