...
public class BoardDAO extends JDBConnect {
	...
	public BoardDTO selectView(String num) {
		...
		// 쿼리문 준비
		// 멤버 테이블과 board 테이블의사용자의 id가 같은 값을 보여준다.
		// board 테이블은 전체, 멤버 테이블은 사용자 이름만
		// 왜냐? board 테이블에 작성자 이름이 없기 때문에!!!
		// 조건은? 사용자가 클릭한 게시글의 num의 값과 동일한 글을 보여준다
	...
	// 지정한 게시물의 조회수를 1 증가시킵ㄴ디ㅏ.
	public void updateVisitCount(String num) {
		// 쿼리문 준비
		// board 테이블을 수정하건데
		// visitcount의 값을 +1해라
		// num은 매개변수로 넘어온 값.
		// 즉 사용자가 클릭한 게시글의 num의 값
