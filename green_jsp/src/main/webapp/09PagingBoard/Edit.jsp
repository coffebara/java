...
<body>
	...
	<form name="writeFrm" method="post" action="EditProcess.jsp"
		...
		<table border="1" width="90%" value="<%=dto.getNum()%>" >
		<tr>
			<td>제목</td>
...
<%-- num, title, content 각 필드에 대해 초기값을 설정하고 있습니다
초기값은 데이터베이스엥서 가져온 원래 게시글의 내용입니다
<%= dto.getNum() %>, <%= dto.getTitle() %>, <%= dto.getContent() %>
사용자가 필드를 수정하고 "작성 완료" 버튼을 클릭 -> onsubmit 이벤트가 실행
-> validateForm(this)를 호출됩니다
 --%>