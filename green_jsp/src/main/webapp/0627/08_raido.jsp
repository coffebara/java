...
<body>
	<form method="get" action="RadioServlet">
		...
		<br><br> <label for="chk_majil"> 메일 정보 수신 여부 : </label>
		<input type="radio" id="chk_mail" name="chk_mail" value="yes" checked> 수신
		<input type="radio" id="chk_mail" name="chk_mail" value="no" checked> 거 부
		<br><br> <label for="content"> 간단한 가입인사를 적어주세요</label>
